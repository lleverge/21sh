...
/*   Updated: 2018/01/17 13:37:08 by vfrolich         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void type_lex_print(t_token_id tok_id)
{
	if (tok_id == 1)
		ft_putendl("PIPE");
	if (tok_id == 2)
...
// static void lex_print(t_lexer *lexlist)
// {
// 	t_lexer *tmp;
...
static void	lex_r_print(t_lexer *lexlist)
{
	t_lexer *tmp;
